...
- **Fable 節約＝セッション分割の徹底（2026-08-10 本人決定）**: 工程・トピックが変われば新セッション、長丁場は `/compact`、リーダーは大物（成果物全文・長ログ）を読まずワーカーに要約させる。120k 超で `context-size-warn.sh` フックが警告→区切りで本人に分割を提案（[[Decisions/2026-08-10-fable-session-split]]）。
